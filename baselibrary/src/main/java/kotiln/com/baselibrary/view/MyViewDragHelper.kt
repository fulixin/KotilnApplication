...
class MyViewDragHelper {
    ...
    private lateinit var iCallBackInface: ICallBackInface
    ...
    private lateinit var mScroller: ScrollerCompat

    private lateinit var mCallback: MyViewDragHelper.Callback
    ...
    companion object {
         ...
         */
        fun create(forParent: ViewGroup, cb: MyViewDragHelper.Callback): MyViewDragHelper {
            return MyViewDragHelper(forParent.context, forParent, cb, null)
        }
         ...
         * @return a new ViewDragHelper instance
         */
        fun create(forParent: ViewGroup, cb: MyViewDragHelper.Callback, iCallBackInface: ICallBackInface?): MyViewDragHelper {
            return MyViewDragHelper(forParent.context, forParent, cb, iCallBackInface!!)
        }
         ...
         * @return a new ViewDragHelper instance
         */
        fun create(forParent: ViewGroup, sensitivity: Float, cb: MyViewDragHelper.Callback): MyViewDragHelper {
     ...
     * @param forParent Parent view to monitor
     */
    constructor(context: Context, forParent: ViewGroup?, cb: MyViewDragHelper.Callback?, iCallBackInface: ICallBackInface?) {
        this.iCallBackInface = iCallBackInface!!
     ...
     * The callback's [MyViewDragHelper.Callback.onEdgeTouched] and
     * [MyViewDragHelper.Callback.onEdgeDragStarted] methods will only be invoked
     ...
     * but [MyViewDragHelper.Callback.tryCaptureView] will not be asked permission to
     * capture this view.
    ...
    fun processTouchEvent(ev: MotionEvent) {
        ...
        when (action) {
            ...
            MotionEvent.ACTION_UP -> {
                ...
                if (!isMove) {
                    try {
                        if (iCallBackInface != null) {
                            iCallBackInface!!.callBack(null)
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                    }
     ...
     * The child order is determined using [MyViewDragHelper.Callback.getOrderedChildIndex].
